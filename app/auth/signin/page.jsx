        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            <Button
              ...
              disabled={loading}
              className="w-full h-12 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-medium text-lg transition-all duration-200 shadow-sm"
              variant="outline"
            >
