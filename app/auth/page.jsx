...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-amber-50 flex items-center justify-center p-4" dir="rtl">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          <p className="text-sm text-emerald-600">
            مجاناً تماماً • آمن ومحمي • يدعم العائلات السعودية
          </p>
          <p className="text-xs text-emerald-500">
            تم التطوير بـ ❤️ لخدمة العائلات في المملكة العربية السعودية
          </p>
        </div>
      </div>
    </div>
